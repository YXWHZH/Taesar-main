...
def main() -> None:
    ...
    # Data
    parser.add_argument("--data", type=str, default="abe")
    parser.add_argument("--n_doms", type=int, default=4, help="# of domains")
    ...
    parser.add_argument("--n_neg", type=int, default=512, help="# negative samples")
    ...
    parser.add_argument("--bs", type=int, default=256, help="train batch size")
    ...
    for epoch in range(1, args.n_epoch + 1):
        ...
        if epoch <= args.n_warmup:
            ...
            # ndcg_val = sum(r["NDCG@10"] for r in res_val)
            ndcg_val = res_val[0]["ndcg@10"]
