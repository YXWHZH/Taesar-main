...
def main_worker():
    ...
    parser.add_argument("--except_type", default=[0, 1, 2, 3, 4], type=list, help="except type index list")  # 13: adot
    ...
    trainer = PretrainProfileTrainer(model, None, None, None, args)
